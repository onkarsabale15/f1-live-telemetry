  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 p-2 sm:px-3.5 sm:py-1.5 bg-white hover:bg-slate-100 text-slate-900 font-semibold text-xs rounded-lg transition-all shadow-md active:scale-95"
      >
        ...
        <span className="hidden sm:inline whitespace-nowrap">Continue with Google</span>
      </button>
